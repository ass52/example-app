...
@endIf
@if(Gate::any(['ad_rewards_allow', 'ad_rewards_edit']))
<li class="nav-item{{ $admiko_data['sideBarActive'] === "ad_rewards" ? " active" : "" }}"><a class="nav-link" href="{{route('admin.ad_rewards.index')}}"><i class="fas fa-align-justify fa-fw"></i>AD Rewards</a></li>
@endIf