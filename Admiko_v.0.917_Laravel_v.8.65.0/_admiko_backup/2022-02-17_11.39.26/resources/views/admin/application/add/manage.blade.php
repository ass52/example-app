            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="click" name="click"  placeholder="Click"  value="{{{ old('click', isset($data)?$data->click : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('click')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="click_help" class="text-muted">{{trans('admiko.seoSlugInfo')}}</small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
