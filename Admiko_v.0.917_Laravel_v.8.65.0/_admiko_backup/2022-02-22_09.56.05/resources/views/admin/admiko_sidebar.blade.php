...
<li class="nav-item{{ $admiko_data['sideBarActive'] === "application" ? " active" : "" }}"><a class="nav-link" href="{{route('admin.application.index')}}"><i class="fas fa-desktop fa-fw"></i>Application</a></li>
@endIf
