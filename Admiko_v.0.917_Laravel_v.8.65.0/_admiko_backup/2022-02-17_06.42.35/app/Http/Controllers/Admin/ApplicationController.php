...
class ApplicationController extends Controller
{
    ...
    public function index()
    {
        ...
        if($Application){
            return redirect(route("admin.application.edit",[$Application->id]));
        } else {
            return redirect(route("admin.application.create"));
        }

        $tableData = Application::orderByDesc("id")->get();
    ...
    public function admiko_dynamic_fields(Request $request,$id)
    {
        if(Gate::none(['application_allow'])) { return redirect(route("admin.application")); }
