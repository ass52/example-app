            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control limitPozNegDecNumbers numbersWidth" id="place_holder_name" name="place_holder_name" 
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control limitPozNegDecNumbers numbersWidth" id="click1" name="click1" 
                                   placeholder="Click" step="0.01"  data-min="1" min="1" data-max="100" max="100" data-decimal="2"
                            ...
                            <small id="click1_help" class="text-muted"> Min: 1 Max: 100</small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
