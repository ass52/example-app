...
class ApplicationController extends Controller
{
    ...
    public function create()
    {
		...
		$verstion_force_update1_all = Application::VERSTION_FORCE_UPDATE1_CONS;
        return view("admin.application.manage")->with(compact('admiko_data','verstion_force_update1_all'));
    }
    ...
    public function edit($id)
    {
		...
		$verstion_force_update1_all = Application::VERSTION_FORCE_UPDATE1_CONS;
        $data = $Application;
        return view("admin.application.manage")->with(compact('admiko_data', 'data','verstion_force_update1_all'));
    }
