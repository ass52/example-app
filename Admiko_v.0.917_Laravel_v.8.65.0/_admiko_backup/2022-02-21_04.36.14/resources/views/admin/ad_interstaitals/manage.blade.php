    ...
    <form method="POST" action="{{ $admiko_data['formAction'] }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <small id="interval1_help" class="text-muted"> Min: -100 Max: 50</small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="place_holdername" class="col-md-2 col-form-label">place holdername:</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="place_holdername" name="place_holdername"  placeholder="place holdername"  value="{{{ old('place_holdername', isset($data)?$data->place_holdername : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('place_holdername')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="place_holdername_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
