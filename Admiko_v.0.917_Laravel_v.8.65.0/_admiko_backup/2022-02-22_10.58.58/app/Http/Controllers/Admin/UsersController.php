...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $tableData = Users::orderByDesc("email")->get();
    ...
    public function create()
    {
		...
		$status1_all = Users::STATUS1_CONS;
        return view("admin.users.manage")->with(compact('admiko_data','roles1_all','status1_all'));
    }
    ...
    public function edit($id)
    {
		...
		$status1_all = Users::STATUS1_CONS;
        $data = $Users;
        return view("admin.users.manage")->with(compact('admiko_data', 'data','roles1_all','status1_all'));
    }
