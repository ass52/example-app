            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap d-none d-md-table-cell">Place holder name</th>
                    ...
                    @foreach($tableData as $data)
                        <tr>
							...
							<td>{{$data->ad_id}} {{$data->interval}} {{$data->click}}</td>
							<td class="text-nowrap d-none d-md-table-cell">{{$data->place_holder_name}}</td>
