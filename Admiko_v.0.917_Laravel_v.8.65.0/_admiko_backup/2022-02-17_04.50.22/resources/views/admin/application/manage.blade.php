            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control form-control-textarea simple_text_editor" id="appdescrption" name="appdescrption"  placeholder="AppDescrption">{{{ old('appdescrption', isset($data)?$data->appdescrption : '') }}}</textarea>
