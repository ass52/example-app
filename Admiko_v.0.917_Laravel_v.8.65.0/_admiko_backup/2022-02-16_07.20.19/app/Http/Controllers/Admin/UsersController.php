...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tableData = Users::search($request->query("search"))->orderByDesc("email")->paginate($request->query("length")??array_key_first(config("admiko_config.length_menu_table")));
    ...
    public function create()
    {
		...
		$role_all = Users::ROLE_CONS;
        return view("admin.users.manage")->with(compact('admiko_data','role_all'));
    }
    ...
    public function edit($id)
    {
		...
		$role_all = Users::ROLE_CONS;
        $data = $Users;
        return view("admin.users.manage")->with(compact('admiko_data', 'data','role_all'));
    }
